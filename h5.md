...
Tein samat purkamis toimenpiteet, kuin aiemmin myös tehtävien alussa. ja navigoin itseni oikean tehtävä kansioon.
<img width="1590" height="492" alt="image" src="https://github.com/user-attachments/assets/e9271b50-23b5-4273-b130-3aca25ae254d" />

Aloitin homman tutkimalla main-funktioita kutsumalla sitä debuggerissa ````disassemble /r main````. Parametri /r. Sieltä löytyi mielenkiintoisia kutsuja, joihin asetin breakpointteja, mutta alkuun niistä ei saanut mitään hyötyä. Kunnes suoritin breakpointin kutsulle mAsdf3a komennolla ````break mAsdf3a```` ja poistin ````delete```` aiemmat breakpointit. Nyt pääsin syöttämään omaa salasanaa ohjelmalle debuggerissa ja sen jälkeen
